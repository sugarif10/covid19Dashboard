...
st.header(":mailbox: Form Tracing COVID-19")

contact_form = """
<form action="https://formsubmit.co/1219110006@global.ac.id" method="POST">
     <input type="hidden" name="_captcha" value="false">
     <input type="text" name="name" placeholder="Nama Anda" required>
     <input type="text" name="age" placeholder="Umur Anda" required>
     ...
     <textarea name="message" placeholder="Tolong sebutkan gejala covid-19 yang tadi sudah dipilih"></textarea>
     <input type="text" name="address" placeholder="Apakah anda terindikasi COVID-19?" required>
...
st.header(":bar_chart: Laporan Hasil Pengguna yang menggunakan Sistem Prediksi COVID-19")

df1 =pd.read_csv('data/lapor.csv')
st.write(df1)
...
#      <textarea name="message" placeholder="Result prediction"></textarea>
#      <button type="submit">Send</button>
# </form>
# """
#
